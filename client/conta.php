                ...
                <form action="conta.php" method="post" enctype="multipart/form-data" onsubmit="return validaForm()">
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="form__group field" style="margin-left: 20px;">
                            <input type="input" maxlength="100" class="form__field" name="numero" id="numero" placeholder="Numero" value="<?php echo $row_conta['numero'];?>" required="">
                            <label for="name" class="form__label">Numero</label>
                        </div>
                        <div class="form__group field" style="margin-left: 20px;">
                            <input type="input" maxlength="100" class="form__field" name="cidade" id="cidade" placeholder="Cidade" value="<?php echo $row_conta['cidade'];?>" required="">
