...
<body id="fundo_index">
    ...
    <main class="container" style="margin-bottom: 80px;">
        <div class="d-flex justify-content-center" style="margin-top: 20px; ">
            <img src="../images/perfil/<?php echo $row_cliente['imagem']; ?>" alt="<?php echo $row_cliente['imagem']; ?>" style="border-radius: 50%; max-width: 150px;">
        </div>
        ...
        <div class="d-flex" style="flex-direction: column;">
            <div class="d-flex justify-content-center" style="margin-bottom: 50px;">
                ...
                <div class="card card_destaque inflar_mouse" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">Notificações sobre o andamento de seus pedidos ou coisas relacionadas.</p>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-center"> 
